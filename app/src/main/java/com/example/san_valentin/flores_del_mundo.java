...
public class flores_del_mundo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flores_del_mundo);
    ...
    public void onClick(View view){
        final int imgBtn1=R.id.imageButton8;
        Intent _volver=null;
        if(view.getId()==imgBtn1){
            _volver=new Intent(flores_del_mundo.this, MainActivity.class);
